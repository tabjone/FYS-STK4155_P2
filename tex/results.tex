...
In run 6 our model reached an accuracy of 0.9825 after 165 epochs. The result was stable
...
use the sigmoid function on the hidden layers and not RELU or Leaky RELU, as
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/PartD/}
\end{figure}
...
convergence rate. Adagrad and manual tuning was inferior to rms prop and adm,
