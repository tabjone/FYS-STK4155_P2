...
L2-regularzation parameter $\lambda $ and differnt learning rates $\eta $ using activation function Sigmoid, ReLU and leaky 
...
$0.0500$ and less than $0.5000$, while $\lambda $ should be less than $0.0100$ or a even smaller value. The best score was achived with 
...
With ReLU as activation function, there seems to be a trend where for smaller $\eta $', larger $\lambda $ is beneficial. The 
best score was obtained with $\eta =0.100$ and $\lambda  =0.0001$. 
